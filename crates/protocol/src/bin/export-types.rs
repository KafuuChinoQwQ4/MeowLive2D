...
fn main() -> ExitCode {
    ...
    let types = [
        ...
        AgentSettings::decl(),
        PersonaProfileSummary::decl(),
        PersonaProfilesSnapshot::decl(),
        PersonaProfileCreateRequest::decl(),
        PersonaProfileIdRequest::decl(),
        PersonaProfileRenameRequest::decl(),
        PersonaProfileUpdateRequest::decl(),
        EventPayload::decl(),
